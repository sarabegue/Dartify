...
public class SharedPreferenceUtils {
    ...
    private SharedPreferenceUtils(Context context) {
        mContext = context;
        mSharedPreferences = context.getSharedPreferences(context.getString(R.string.sharedpreferencesname), Context.MODE_PRIVATE);
    ...
    public String getStringValue(String key, String defaultValue) {
        String cosa = mSharedPreferences.getString(key, defaultValue);
        return cosa;
    }
