...
public class GetMatchesTask extends AsyncTask<String, Void, String> {
    ...
    public GetMatchesTask(Context context) {
        this.c = context;
        this.query = getQueryString();
        dao = MatchDatabase.getInstance(context).datacardDAO();
    ...
    private String getQueryString() {
        ...
        return c.getString(R.string.match_matches) + userid;
    }
