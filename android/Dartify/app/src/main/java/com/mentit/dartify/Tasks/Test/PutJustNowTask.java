...
public class PutJustNowTask extends AsyncTask<String, Void, String> {
    private Context context;
    private OnTaskCompleted taskCompleted;
    long userid;
    ArrayList<String> lista;

    public PutJustNowTask(Context activityContext, long userid, ArrayList lista) {
    ...
    protected String doInBackground(String... strings) {
        ...
        ejecutarConsulta(context.getString(R.string.quiz_justnow), jsonObject);
        return "";
    }
    ...
    private void ejecutarConsulta(final String query, final JSONObject bodydata) {
        new Thread(() -> {
            ...
            if (!respuesta.error()) {
                taskCompleted.OnTaskJustNowQuiz();
            }
        }).start();
    }

    public interface OnTaskCompleted {
        void OnTaskJustNowQuiz();
    }
}